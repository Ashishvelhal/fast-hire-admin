...
// import { createSubCategory, updateSubCategory, deleteSubCategory } from "./SubCategory";
...
//       } else {
//         await createSubCategory(categoryId, { subcategoryname: subCategoryName, categoryId }, authToken);
...
//       render: (_, record) => (
//         <div >
//           <AntButton type="primary" size="small" onClick={() => handleViewSkills(record)}>
//             View Skills
//           </AntButton>
//         </div>
//       ),
...
//           Back
//         </Button>
//         <Skills subCategoryId={selectedSubCategory.id} subCategoryName={selectedSubCategory.subcategoryname} />
//       </Box>
//     );
//   }
