  ...
  //   // Fetch Industries, Companies, Plans
  //   useEffect(() => {
  ...
  //       try {
  //         const [industryRes, companyRes, planRes] = await Promise.all([
  ...
  //         newEndDate.setMonth(
  //           newEndDate.getMonth() + selectedPlan.durationInMonths
  //         );
  ...
  return (
    <Box sx={{ fontSize: "0.85rem" }}>
      ...
      <Grid container spacing={1.5} className="textField-root">
        ...
        {/* Remaining fields unchanged but small-sized */}
        <Grid item xs={12} sm={6} md={3}>
          <TextField
            size="small"
            label="Founded Year"
