...
const navItems = [
    { label: "Create Employer", to: "/admin/fasthireadminlayout/employe" },
    { label: "Employer List", to: "/admin/fasthireadminlayout/employerlist" }
];
    ...
    const filteredNavItems = navItems.filter((item) => {
        if (
            ...
            (
                ...
                item.label === "Create Employer" ||
                item.label === "Employer List"
            )
        )
            if (
                role === "manager" &&
